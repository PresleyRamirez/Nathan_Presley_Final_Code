...
sample_name  = "KSP10_1WP4" #name written on sample
step_name    = ""   #qualifier for multiple steps done in a day or other info
data = read.table("C:/Users/Pichy/Desktop/R stuff/ENCE 105/Final Project/Git/Nathan_Presley_Final_Code/20140911KSP10_2WP4.txt", quote="\"")
...
reading_date = "20140912" #date that step was taken, YYYYMMDD
sample_name  = "KSP10_1WP4" #name written on sample
step_name    = ""   #qualifier for multiple steps done in a day or other info
data = read.table("C:/Users/Pichy/Desktop/R stuff/ENCE 105/Final Project/Git/Nathan_Presley_Final_Code/20140911KSP10_2WP4.txt", quote="\"")
colnames(data) <- c("Week day","Month","day","Time","Year","Minutes","Temperature","Water_Potential","pF")
...
reading_date = "20140911" #date that step was taken, YYYYMMDD
sample_name  = "KSP10_3WP4" #name written on sample
step_name    = ""   #qualifier for multiple steps done in a day or other info
data = read.table("C:/Users/Pichy/Desktop/R stuff/ENCE 105/Final Project/Git/Nathan_Presley_Final_Code/20140911KSP10_2WP4.txt", quote="\"")
colnames(data) <- c("Week day","Month","day","Time","Year","Minutes","Temperature","Water_Potential","pF")
data$Potential_bar <- -10*data$Water_Potential
